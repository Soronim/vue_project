<template>
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="">Войти</a>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4 justify-content-center justify-content-lg-between">
          <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h1 data-aos="fade-up">Столовая Брахиумского<br>галактического университета</h1>
            <p data-aos="fade-up" data-aos-delay="100">Лучшая столовая в созвездии Весов</p>
            <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
              <a href="#book-a-table" class="btn-get-started">Заказать столик</a>              
            </div>
          </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>О нас<br></h2>
        <p><span>Немного информации</span> <span class="description-title">О нас</span></p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="250">
            <div class="content ps-0 ps-lg-5">
              ...
              <p>Подробнее (тут <a href="https://ru.wikipedia.org/wiki/%D0%A1%D0%B8%D0%B3%D0%BC%D0%B0_%D0%92%D0%B5%D1%81%D0%BE%D0%B2">ссылка</a>)</p>
    ...
    <section id="stats" class="stats section dark-background">
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="offset-lg-3 offset-md-3 col-lg-3 col-md-6">
    ...
    <section id="menu" class="menu section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Меню</h2>
        <p><span>Наше</span> <span class="description-title">Меню</span></p>
      </div><!-- End Section Title -->
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="product.html"><img src="/img/menu/menu-item-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
    ...
    <section id="book-a-table" class="book-a-table section ">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p><span>Закажите</span> <span class="description-title">столик<br></span></p>
      </div><!-- End Section Title -->
          ...
          <div class="col-lg-8 d-flex align-items-center reservation-form-bg" data-aos="fade-up" data-aos-delay="200">
            <form action="#" method="post" role="form" class="php-email-form">
              <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6">
                  <input type="date" name="date" class="form-control" id="date" placeholder="Дата" required="">
                </div>
                <div class="col-lg-4 col-md-6">
                  <input type="time" class="form-control" name="time" id="time" placeholder="Время" required="">
                </div>
                <div class="col-lg-4 col-md-6">
                  <input type="number" class="form-control" name="people" id="people" placeholder="Количество гостей" required="">
                </div>
              </div>

              <div class="text-center mt-3">                
                <button type="submit">Заказать столик</button>
              </div>
            </form>
